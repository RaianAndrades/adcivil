...
<div class="container"> 
  ...
  <div class="row clearfix">
        ...
        <div class="col-md-4 column">
          <h3>
            Lista de advogados cadastrados no processo
          </h3>
        </div>
        <div class="col-md-4 column">
      ...
      <div class="row clearfix">
          ...
          <div class=" table-responsive">    
           <table class="table table-striped table-bordered">
              ...
              <tbody>
                <?php
                foreach($processos_advogados as $advogado) : ?> <!-- LISTA DE ADVOGADOS CADASTRADOS NO PROCESSO -->
              <?php // if(isset($processos_advogados) && $processos_advogados!='') { ?> 
              <?php echo '<tr>' ?>
         <!--     <?php// echo '<td>' ?>  <?php// echo $advogado->idProcesso ;?> <?php// echo '</td>' ?>  -->
              ...
              <?php echo '<td>' ?>  <a href="<?php echo base_url()."admin/advogados/ver/" . $advogado->idAdvogado ;?>"><?php echo $advogado->nome_advogado ;?></a> <?php echo '</td>' ?>
                     ...
                     <!--        <?php /*echo '<td>' ?>  <a href="<?php echo base_url()."admin/processos_clientes/editar/" . $processo->idProcesso_Cliente; ?>"; title="Alterar"><img src="../Assets/imgs/gear.gif"></a>  <?php echo '</td>'*/ ?> -->
                            <?php echo '<td>' ?>  <a href="<?php echo base_url()."admin/processos_advogados/excluir/" . $advogado->idProcesso_Advogado; ?>"; onclick="return confirm('Você tem certeza que deseja excluir o advogado deste processo?');" title="Excluir"><img src="<?php echo base_url();?>Assets/imgs/xis.gif"></a>  <?php echo '</td>' ?>
<!--                        <?php //echo '<td>' ?>  <a href="<?php //echo base_url()."admin/processos_advogados/excluir/" . $advogado->idProcesso_Advogado . $advogado->idProcesso; ?>"; onclick="return confirm('Você tem certeza que deseja excluir o advogado deste processo?');" title="Excluir"><img src="../Assets/imgs/xis.gif"></a>  <?php// echo '</td>' ?>
 -->              <?php
                  //  } else {
                  //   echo "Não existem advogados cadastrados neste processo.";
                  //  } 
                  ?>
 ...
 <div class="row clearfix">
    ...
    <div class="col-md-4 column">
          <h3>
           Cadastrar novo advogado no processo
          </h3>
        </div>
      <div class="col-md-4 column"></div>
  </div>       
     ...
     <!--  INICIO FORMULARIO CADASTRAR ADVOGADO -->
     <div class="row clearfix">
        <div class="col-md-3 column"></div>
        <div class="col-md-6 column">
         <form class="form-horizontal" role="form" action="<?php echo base_url();?>admin/processos/adicionar_advogado" method="post">
           <div class="form-group">
                  <input class="form-control" type="hidden" required name="idProcesso" value="<?php echo $p->idProcesso; ?>" />
              </div> 
              <div class="form-group">
                <label class="control-label" for="idAdvogado">Advogado :</label>
                 <select class="form-control" name="idAdvogado" class="btn-slide" value="<?php echo set_value('idAdvogado');?> " >
                     <option value=""></option> 
                        <?php $this->advogados->showAdvogados(); ?>
                  </select>  
              </diV>
