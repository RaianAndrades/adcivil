   ...
   <div class="row clearfix">
        ...
        <div class="col-md-6 column">
           ...
           <form class="form-horizontal" role="form" action="<?php echo base_url();?>admin/processos_audiencias/adicionar_audiencia" method="post">
              ...
              <div class="form-group">
                <label class="control-label" for="idProcesso">Numero processo:</label>
                 <select class="form-control" name="idProcesso" class="btn-slide" value="<?php echo set_value('idNumeroProcesso');?> " >
                     <option value=""></option> 
                        <?php $this->processos->showProcessos(); ?>
                  </select>  
              </diV>
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                   ...
                   <input class="form-control" type="text" placeholder="Horário"  name="horario" value="<?php echo set_value('horario'); ?>" />
                </div>
