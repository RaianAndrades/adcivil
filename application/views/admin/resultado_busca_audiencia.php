...
<div class="container"> 
  ...
  <div class="row clearfix">
        ...
        <div class="col-md-4 column">
          <h3>
           Sua busca por <span class='blue'><?php echo $busca;?></span>, encontrou <?php echo count($processos_audiencias) ?> resultado(s).
          </h3>
        </div>
        <div class="col-md-4 column">
        </div>
              ...
              <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="header">Horário</th>
                    <th class="header">Vara</th>
                  </tr>
                 </thead>
                <tbody>
                  <?php
                    foreach($processos_audiencias as $audiencia) : ?> <!-- RESULTADOS BUSCA AUDIENCIAS -->
                   <?php echo '<tr>' ?>  
