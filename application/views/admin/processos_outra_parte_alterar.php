...
<div class="container"> 
  ...
  <div class="row clearfix">
        ...
        <div class="col-md-4 column">
          <h3>
            Alteração de outra(s) parte(s) cadastradas no processo
          </h3>
        </div>
          <div class="col-md-4 column">
       ...
       <?php  foreach($processosOutra as $p) : ?>
             <!--<?php// echo $processo->idProcesso; ?> -->
        <?php endforeach; ?> 

     <!--  INICIO FORMULARIO ALTERAR OUTRA PARTE-->
     <div class="row clearfix">
         <div class="col-md-3 column">
        </div> 
        <div class="col-md-6 column">
         <form class="form-horizontal" role="form" action="<?php echo base_url()?>admin/processos_outra_parte/gravar_alteracao" method="post">
              
           <div class="form-group">
                  <input class="form-control" type="hidden" required name="idProcesso_Outra_Parte" value="<?php echo $p->idProcesso_Outra_Parte; ?>" />
              </div> 
           ...
           <div class="form-group">
              ...
              <div class="form-group">
                 ...
                 <input class="form-control" type="text" placeholder="Nome" required name="nome_outra_parte" value="<?php echo $p->nome_outra_parte; ?>" />
             </div>  
             ...
             <div class="form-group">
                 ...
                 <input class="form-control" id="telefoneOne" type="text" placeholder="Telefone 1"  name="telefoneOne" value="<?php echo $p->telefoneOne; ?>" />
             </div>  

            <div class="form-group">
                 <label class="control-label" for="telefoneTwo">Telefone 2:</label>
                 <input class="form-control" id="telefoneTwo" type="text" placeholder="Telefone 2"  name="telefoneTwo" value="<?php echo $p->telefoneTwo; ?>" />
             </div>  
             ...
             <div class="form-group">
                 ...
                 <input class="form-control" type="text" placeholder="estado_civil"  name="estado_civil" value="<?php echo $p->estado_civil; ?>" />
             </div> 

             <div class="form-group">
                 <label class="control-label" for="nacionalidade">Nacionalidade:</label>
                 <input class="form-control" type="text" placeholder="nacionalidade"  name="nacionalidade" value="<?php echo $p->nacionalidade; ?>" />
             </div> 

             <div class="form-group">
                 <label class="control-label" for="profissao">Profissão:</label>
                 <input class="form-control" type="text" placeholder="profissao"  name="profissao" value="<?php echo $p->profissao; ?>" />
             </div> 
