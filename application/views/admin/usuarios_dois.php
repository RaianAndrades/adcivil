  ...
  <div class="row clearfix">
    ...
    <div class="row clearfix">
        <div class="col-md-4 column">
          ...
          <p>
                 <button class="btn btn-default btn-lg">  <a href="<?php echo base_url()."admin/usuarios/cadastrar_usuario"?>"; > Cadastrar novo usuario</a> </button> 
          </p>
        </div>
        <div class="col-md-4 column">
        ...
        <div class="col-md-4 column">
            ...
            <form class="navbar-form navbar-right" role="busca" action="<?php echo base_url();?>admin/usuarios/buscar" method="post">
              ...
              <table class="table table-striped table-bordered">
                <thead>
                  ...
                  <!--   <th class="header">id usuario</th> -->
                    ...
                    <th class="header">Senha</th>
                    <th class="header">Acesso</th>
                ...
                <tbody>
                  <?php
                    foreach($usuarios as $usuario) : ?> <!-- LISTA DE USUARIOS-->
                   <?php echo '<tr>' ?>  
                    <!--  <?php// echo '<td>' ?>  <?php// echo $usuario->id ;?> <?php// echo '</td>' ?> -->
                     <?php echo '<td>' ?>  <a href="<?php echo base_url()."admin/usuarios/ver/" . $usuario->id ;?>"><?php echo $usuario->nome ; ?></a> <?php echo '</td>' ?>
                     <?php echo '<td>' ?>  <?php echo $usuario->email ;?> <?php echo '</td>' ?> 
                     <?php echo '<td>' ?>  <?php echo $usuario->username ;?> <?php echo '</td>' ?>
                     <?php echo '<td>' ?>  <?php echo $usuario->password ;?> <?php echo '</td>' ?>
                     <?php echo '<td>' ?>  <?php echo $usuario->access ;?> <?php echo '</td>' ?>
                      

                            <?php echo '<td>' ?>  <a href="<?php echo base_url()."admin/usuarios/editar/" . $usuario->id; ?>"; title="Alterar"><img src=<?php echo base_url()."Assets/imgs/gear.gif"; ?>></a> <?php echo '</td>' ?>
                            <?php echo '<td>' ?>  <a href="<?php echo base_url()."admin/usuarios/excluir/" . $usuario->id; ?>"; onclick="return confirm('Você tem certeza que deseja excluir este usuario?');" title="Excluir"><img src=<?php echo base_url()."Assets/imgs/xis.gif"; ?>></a> <?php echo '</td>' ?>
