...
<!-- CADASTRAR NOVO ADVOGADO  -->
  ...
  <div class="row clearfix">
        ...
        <div class="col-md-6 column">
          ...
          <form class="form-horizontal" role="form" action="<?php echo base_url();?>admin/usuarios/adicionar" method="post">
             <div class="form-group">
                <label class="control-label" for="nome">Nome:</label>
                <input class="form-control" type="text" placeholder="Nome" name="nome" required  value="<?php echo set_value('nome'); ?>" />
             </div>  
             ...
             <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Usuário" name="username"  value="<?php echo set_value('username'); ?>" />
             </div>  

             <div class="form-group">
                <label class="control-label" for="password">Senha:</label>
                <input class="form-control" type="text" placeholder="Senha" name="password"  value="<?php echo set_value('password'); ?>" />
             </div>  

            <!--  <div class="form-group">
                <label class="control-label" for="access">Tipo de acesso:</label>
                Administrador<input class="form-control" type="radio" name="access"  value="adm" />
                Advogado/estagiário<input class="form-control" type="radio" name="access"  value="adv" />
             </div>-->
