...
<div class="container"> 
  ...
  <div class="row clearfix">
   ...
   <div class="row clearfix">
		...
		foreach($usuarios as $usuario) : ?>  <!-- INFORMAÇÕES DO PROCESSO -->

			<ul class="list-group">
		  	<!-- 	<li class="list-group-item">Id usuario: <?php// echo $usuario->id; ?></li> -->
		  		<li class="list-group-item">Nome: <?php echo $usuario->nome; ?></li>
		  		<li class="list-group-item">Email: <?php echo $usuario->email; ?></li>
		  		<li class="list-group-item">Usuário: <?php echo $usuario->username; ?></li>
		  		<li class="list-group-item">Senha: <?php echo $usuario->password; ?></li>
		  		<li class="list-group-item">Acesso: <?php echo $usuario->access; ?></li>
		  	</ul>	
