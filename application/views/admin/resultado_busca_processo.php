...
<div class="container"> 
  ...
  <div class="row clearfix">
        ...
        <div class="col-md-4 column">
          <h3>
           Sua busca por <span class='blue'><?php echo $busca;?></span>, encontrou <?php echo count($processos) ?> resultado(s).
          </h3>
        </div>
        <div class="col-md-4 column">
        </div>
              ...
              <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="header">Advogado</th> -->
                    <th class="header">Tipo de ação</th>
                    <th class="header">Data de abertura</th>
                  </tr>
                 </thead>
                <tbody>
                  <?php
                    foreach($processos as $processo) : ?> <!-- RESULTADO BUSCA PROCESSO -->
                   <?php echo '<tr>' ?>  
                    ...
                    <!--   <?php// echo '<td>' ?>  <a href="<?php// echo base_url()."admin/clientes/ver/" . $processo->idCliente ;?>"><?php// echo $processo->nome_cliente ;?></a> <?php// echo '</td>' ?>
                      <?php// echo '<td>' ?>  <a href="<?php// echo// base_url()."admin/advogados/ver/" . $processo->idAdvogado ;?>"><?php// echo $processo->nome_advogado ;?></a> <?php// echo '</td>' ?> -->
