...
<div class="container"> 
  ...
  <div class="row clearfix">
   ...
   <div class="row clearfix">
		...
		foreach($processos_audiencias as $audiencia) : ?> <!-- INFORMAÇÕES DA AUDIÊNCIA -->

            <ul class="list-group">
                <!-- <li class="list-group-item">Id Audiencia: <?php// echo $audiencia->idProcesso_Audiencia; ?></li>
                <li class="list-group-item">id processo: <?php// echo $audiencia->idProcesso; ?></li> -->
                <li class="list-group-item">Data: <?php echo date("d/m/Y", strtotime ($audiencia->data)); ?></li>
                <li class="list-group-item">Horário: <?php echo $audiencia->horario; ?></li>
                <li class="list-group-item">Vara: <?php echo $audiencia->vara; ?></li>
                <li class="list-group-item">Cidade: <?php echo $audiencia->cidade; ?></li>
                <li class="list-group-item">Tipo de audiência: <?php echo $audiencia->tipo_audiencia; ?></li>
                <li class="list-group-item">Observação: <?php echo $audiencia->observacao; ?></li>
            </ul> 
